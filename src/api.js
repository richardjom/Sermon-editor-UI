...
export async function renderClip(clipId, { startSeconds, endSeconds, captionPosition, captionOutline, captionFont, captionUppercase, captionBold, captionHighlight, emphasis, manualFrameX, vertical } = {}) {
  const body = {}
  ...
  // Accent/punch words for the serif_accent template (rendered in the italic serif).
  if (Array.isArray(emphasis)) body.emphasis = emphasis
